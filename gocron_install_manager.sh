...
do
	...
	echo "For Example:/home/$USER/DataCenterProject/gocron_workspace "
...
echo "############################################################################"
echo "##									##"
echo "##	检测是否有gocron_dockerImage:py26_cpu	##"
echo "##	编译.../Dockerfile		##"
echo "##									##"
echo "############################################################################"
...
then
	...
	then
		sudo docker build -t $IMAGENAME:$IMAGETAGCPU -f ${VOLUMEPATH}/docker/Dockerfile ${VOLUMEPATH}
